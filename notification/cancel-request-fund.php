...
class CancelRequestFund extends \SejoliSA\Notification\Main {
    ...
    public function add_setting_fields(array $fields) {
        ...
        $fields['cancel-request-fund'] = [
			'title'  => __('Pembatalan Pencairan Dana', 'sejoli'),
			'fields' => [

                // Untuk buyer
				Field::make('separator'	,'sep_cancel_request_fund_email', 	__('Email' ,'sejoli'))
				...
				Field::make('separator'	,'sep_cancel_request_fund_sms', 	__('SMS' ,'sejoli'))
					->set_help_text(__('Pengaturan konten untuk media sms', 'sejoli')),

				Field::make('textarea', 'cancel_request_fund_sms_content', __('Konten', 'sejoli'))
                    ->set_default_value(sejoli_get_notification_content('request-fund', 'sms')),

				Field::make('separator'	,'sep_cancel_request_fund_whatsapp', 	__('WhatsApp' ,'sejoli'))
					->set_help_text(__('Pengaturan konten untuk media whatsapp', 'sejoli')),

				Field::make('textarea', 'cancel_request_fund_whatsapp_content', __('Konten', 'sejoli'))
                    ->set_default_value(sejoli_get_notification_content('request-fund', 'whatsapp')),

                // Untuk admin
				Field::make('separator', 	'sep_cancel_request_fund_admin', 		__('Konten untuk admin dan lainnya','sejoli'))
					->set_classes('main-title'),

				Field::make('checkbox',		'cancel_request_fund_admin_active',	__('Aktifkan notifikasi untuk admin', 'sejoli'))
                    ->set_default_value(true),

				Field::make('separator',	'sep_cancel_request_fund_admin_email', 	__('Email' ,'sejoli'))
				...
				Field::make('text',		'cancel_request_fund_admin_email_recipient', __('Alamat Email Penerima', 'sejoli'))
				...
				Field::make('rich_text', 'cancel_request_fund_admin_email_content', __('Konten', 'sejoli'))
					->set_required(true)
					->set_default_value(sejoli_get_notification_content('cancel-request-fund-admin'))
					->set_conditional_logic([
						[
							'field'	=> 'cancel_request_fund_admin_active',
							'value' => true,
				...
				Field::make('separator'	,'sep_cancel_request_fund_admin_sms', 	__('SMS' ,'sejoli'))
					->set_help_text(__('Pengaturan konten untuk media sms', 'sejoli'))
					->set_conditional_logic([
						[
							'field'	=> 'cancel_request_fund_admin_active',
				...
				Field::make('text',		'cancel_request_fund_admin_sms_recipient', __('Nomor SMS Penerima', 'sejoli'))
					->set_help_text(__('Gunakan tanda koma jika penerima ada lebih dari 1', 'sejoli'))
					->set_conditional_logic([
						[
							'field'	=> 'cancel_request_fund_admin_active',
				...
				Field::make('textarea', 'cancel_request_fund_admin_sms_content', __('Konten', 'sejoli'))
					->set_help_text(__('Dengan mengosongkan isian ini, tidak akan ada notifikasi yang dikirimkan via sms'))
					->set_default_value(sejoli_get_notification_content('cancel-request-fund-admin', 'sms'))
					->set_conditional_logic([
						[
							'field'	=> 'cancel_request_fund_admin_active',
							'value' => true,
				...
				Field::make('separator'	,'sep_cancel_request_fund_admin_whatsapp', 	__('WhatsApp' ,'sejoli'))
					->set_help_text(__('Pengaturan konten untuk media whatsapp', 'sejoli'))
					->set_conditional_logic([
						[
							'field'	=> 'cancel_request_fund_admin_active',
				...
				Field::make('text',		'cancel_request_fund_admin_whatsapp_recipient', __('Nomor WhatsApp Penerima', 'sejoli'))
					->set_help_text(__('Gunakan tanda koma jika penerima ada lebih dari 1', 'sejoli'))
					->set_conditional_logic([
						[
							'field'	=> 'cancel_request_fund_admin_active',
				...
				Field::make('textarea', 'cancel_request_fund_admin_whatsapp_content', __('Konten', 'sejoli'))
					->set_help_text(__('Dengan mengosongkan isian ini, tidak akan ada notifikasi yang dikirimkan via whatsapp'))
					->set_default_value(sejoli_get_notification_content('cancel-request-fund-admin', 'whatsapp'))
					->set_conditional_logic([
						[
							'field'	=> 'cancel_request_fund_admin_active',
							'value' => true,
